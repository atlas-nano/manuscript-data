...
#energy_Au_111_Cu2O_Layer_1_solv_oxide, intensity_Au_111_Cu2O_Layer_1_solv_oxide = norm_area("polAvg_Au_111_Cu2O_Layer_1_solv_oxide.dat")
#shift_Au_111_Cu2O_Layer_1_solv_oxide = getShift('david_Au_111_Cu2O_Layer_1_solv_oxide.csv')
#print('Au_111_Cu2O_Layer_1_solv_oxide total_shift: ' + str(shift_Au_111_Cu2O_Layer_1_solv_oxide + d_exp))
#energy_Au_111_Cu2O_Layer_1_solv_oxide += shift_Au_111_Cu2O_Layer_1_solv_oxide+ d_exp
#x_Au_111_Cu2O_Layer_1_solv_oxide,y_Au_111_Cu2O_Layer_1_solv_oxide  = givePeak(energy=energy_Au_111_Cu2O_Layer_1_solv_oxide, intensity=intensity_Au_111_Cu2O_Layer_1_solv_oxide, name='Au_111_Cu2O_Layer_1_solv_oxide')
...
#
#energy_Au_111_CuO_Layer_1_solv_oxide, intensity_Au_111_CuO_Layer_1_solv_oxide = norm_area("polAvg_Au_111_CuO_Layer_1_solv_oxide.dat")
#shift_Au_111_CuO_Layer_1_solv_oxide = getShift('david_Au_111_CuO_Layer_1_solv_oxide.csv')
#print('Au_111_CuO_Layer_1_solv_oxide total_shift: ' + str(shift_Au_111_CuO_Layer_1_solv_oxide + d_exp))
#energy_Au_111_CuO_Layer_1_solv_oxide += shift_Au_111_CuO_Layer_1_solv_oxide+ d_exp
#x_Au_111_CuO_Layer_1_solv_oxide,y_Au_111_CuO_Layer_1_solv_oxide  = givePeak(energy=energy_Au_111_CuO_Layer_1_solv_oxide, intensity=intensity_Au_111_CuO_Layer_1_solv_oxide, name='Au_111_CuO_Layer_1_solv_oxide')


energy_Au_111_CuO_Layer_0_solv_oxide_mag, intensity_Au_111_CuO_Layer_0_solv_oxide_mag = norm_area("polAvg_Au_111_CuO_Layer_0_solv_oxide_mag.dat")
...
x_Au_111_CuO_Layer_0_solv_oxide_mag,y_Au_111_CuO_Layer_0_solv_oxide_mag  = givePeak(energy=energy_Au_111_CuO_Layer_0_solv_oxide_mag, intensity=intensity_Au_111_CuO_Layer_0_solv_oxide_mag, name='Au_111_CuO_Layer_0_solv_oxide_mag')

energy_Au_111_CuO_Layer_1_solv_oxide_mag, intensity_Au_111_CuO_Layer_1_solv_oxide_mag = norm_area("polAvg_Au_111_CuO_Layer_1_solv_oxide_mag.dat")
...
x_Au_111_CuO_Layer_1_solv_oxide_mag,y_Au_111_CuO_Layer_1_solv_oxide_mag  = givePeak(energy=energy_Au_111_CuO_Layer_1_solv_oxide_mag, intensity=intensity_Au_111_CuO_Layer_1_solv_oxide_mag, name='Au_111_CuO_Layer_1_solv_oxide_mag')
...
#plt.plot(energy_Au_111_Cu_ohx2_atom_hydroxide, intensity_Au_111_Cu_ohx2_atom_hydroxide+yoffset*2, label='Au_111_Cu_ohx2_atom_hydroxide', linewidth=2, color='deepskyblue', linestyle='--')
...
#    ha='center', fontproperties=arial, color='black') 
#
#plt.plot(energy_Au_111_Cu_oh_atom_hydroxide, intensity_Au_111_Cu_oh_atom_hydroxide+yoffset*3, label='Au_111_Cu_oh_atom_hydroxide', linewidth=2, color='blue', )
...
#    ha='center', fontproperties=arial, color='black') 
#
#plt.plot(energy_Au_111_Cu2O_atom_oxide, intensity_Au_111_Cu2O_atom_oxide+yoffset*4, label='Au_111_Cu2O_atom_oxide', linewidth=2, color='blue', linestyle='--')
...
#    ha='center', fontproperties=arial, color='black') 
#
#plt.plot(energy_bulkCu2O, intensity_bulkCu2O+yoffset*6, label='bulkCu2O', linewidth=2, color='darkviolet', linestyle='--')
...
plt.plot(energy_Au_111_CuOH2_Layer_0_solv_hydroxide, intensity_Au_111_CuOH2_Layer_0_solv_hydroxide+yoffset*0, label='Au_111_CuOH2_Layer_0_solv_hydroxide', linewidth=2, color='purple', )
if x_Au_111_CuOH2_Layer_0_solv_hydroxide is not None and y_Au_111_CuOH2_Layer_0_solv_hydroxide is not None:
    plt.annotate(f'{x_Au_111_CuOH2_Layer_0_solv_hydroxide:.1f}', (x_Au_111_CuOH2_Layer_0_solv_hydroxide, y_Au_111_CuOH2_Layer_0_solv_hydroxide+yoffset*0),
    textcoords="offset points", xytext=(0,2), 
    ha='center', fontproperties=arial, color='black') 

#plt.plot(energy_Au_111_Cu2O_Layer_1_solv_oxide, intensity_Au_111_Cu2O_Layer_1_solv_oxide+yoffset*1, label='Au_111_Cu2O_Layer_1_solv_oxide', linewidth=2, color='#F14040', )
#if x_Au_111_Cu2O_Layer_1_solv_oxide is not None and y_Au_111_Cu2O_Layer_1_solv_oxide is not None:
#    plt.annotate(f'{x_Au_111_Cu2O_Layer_1_solv_oxide:.1f}', (x_Au_111_Cu2O_Layer_1_solv_oxide, y_Au_111_Cu2O_Layer_1_solv_oxide+yoffset*1),
#    textcoords="offset points", xytext=(0,2), 
#    ha='center', fontproperties=arial, color='black')



plt.plot(energy_Au_111_Cu2O_Layer_0_solv_oxide, intensity_Au_111_Cu2O_Layer_0_solv_oxide+yoffset*1, label='Au_111_Cu2O_Layer_0_solv_oxide', linewidth=2, color='#F14040', )
if x_Au_111_Cu2O_Layer_0_solv_oxide is not None and y_Au_111_Cu2O_Layer_0_solv_oxide is not None:
    plt.annotate(f'{x_Au_111_Cu2O_Layer_0_solv_oxide:.1f}', (x_Au_111_Cu2O_Layer_0_solv_oxide, y_Au_111_Cu2O_Layer_0_solv_oxide+yoffset*1),
    textcoords="offset points", xytext=(0,2), 
    ha='center', fontproperties=arial, color='black') 

plt.plot(energy_Au_111_Cu2O_Layer_1_solv_oxide_mag, intensity_Au_111_Cu2O_Layer_1_solv_oxide_mag+yoffset*2, label='Au_111_Cu2O_Layer_1_solv_oxide_mag', linewidth=2, color='#F14040', )
if x_Au_111_Cu2O_Layer_1_solv_oxide_mag is not None and y_Au_111_Cu2O_Layer_1_solv_oxide_mag is not None:
    plt.annotate(f'{x_Au_111_Cu2O_Layer_1_solv_oxide_mag:.1f}', (x_Au_111_Cu2O_Layer_1_solv_oxide_mag, y_Au_111_Cu2O_Layer_1_solv_oxide_mag+yoffset*2),
    textcoords="offset points", xytext=(0,2), 
    ha='center', fontproperties=arial, color='black') 

#plt.plot(energy_Au_111_CuO_Layer_0_solv_oxide, intensity_Au_111_CuO_Layer_0_solv_oxide+yoffset*2.3, label='Au_111_CuO_Layer_0_solv_oxide', linewidth=2, color='#1A6FDF', )
#if x_Au_111_CuO_Layer_0_solv_oxide is not None and y_Au_111_CuO_Layer_0_solv_oxide is not None:
#    plt.annotate(f'{x_Au_111_CuO_Layer_0_solv_oxide:.1f}', (x_Au_111_CuO_Layer_0_solv_oxide, y_Au_111_CuO_Layer_0_solv_oxide+yoffset*2.3),
#    textcoords="offset points", xytext=(0,2), 
#    ha='center', fontproperties=arial, color='black')
plt.plot(energy_Au_111_CuO_Layer_0_solv_oxide_mag, intensity_Au_111_CuO_Layer_0_solv_oxide_mag+yoffset*3.3, label='Au_111_CuO_Layer_0_solv_oxide_mag', linewidth=2, color='#1A6FDF', )
if x_Au_111_CuO_Layer_0_solv_oxide_mag is not None and y_Au_111_CuO_Layer_0_solv_oxide_mag is not None:
    plt.annotate(f'{x_Au_111_CuO_Layer_0_solv_oxide_mag:.1f}', (x_Au_111_CuO_Layer_0_solv_oxide_mag, y_Au_111_CuO_Layer_0_solv_oxide_mag+yoffset*3.3),
    textcoords="offset points", xytext=(0,2), 
    ha='center', fontproperties=arial, color='black')

#plt.plot(energy_Au_111_CuO_Layer_1_solv_oxide, intensity_Au_111_CuO_Layer_1_solv_oxide+yoffset*3.3, label='Au_111_CuO_Layer_1_solv_oxide', linewidth=2, color='#1A6FDF', )
#if x_Au_111_CuO_Layer_1_solv_oxide is not None and y_Au_111_CuO_Layer_1_solv_oxide is not None:
#    plt.annotate(f'{x_Au_111_CuO_Layer_1_solv_oxide:.1f}', (x_Au_111_CuO_Layer_1_solv_oxide, y_Au_111_CuO_Layer_1_solv_oxide+yoffset*3.3),
#    textcoords="offset points", xytext=(0,2),
#    ha='center', fontproperties=arial, color='black') 
plt.plot(energy_Au_111_CuO_Layer_1_solv_oxide_mag, intensity_Au_111_CuO_Layer_1_solv_oxide_mag+yoffset*4.3, label='Au_111_CuO_Layer_1_solv_oxide_mag', linewidth=2, color='#1A6FDF', )
if x_Au_111_CuO_Layer_1_solv_oxide_mag is not None and y_Au_111_CuO_Layer_1_solv_oxide_mag is not None:
    plt.annotate(f'{x_Au_111_CuO_Layer_1_solv_oxide_mag:.1f}', (x_Au_111_CuO_Layer_1_solv_oxide_mag, y_Au_111_CuO_Layer_1_solv_oxide_mag+yoffset*4.3),
    textcoords="offset points", xytext=(0,2),
    ha='center', fontproperties=arial, color='black') 

plt.plot(energy_Au_111_Cu_layer, intensity_Au_111_Cu_layer+yoffset*5.5, label='Au_111_Cu_layer', linewidth=2, color='#37AD6B', )
if x_Au_111_Cu_layer is not None and y_Au_111_Cu_layer is not None:
    plt.annotate(f'{x_Au_111_Cu_layer:.1f}', (x_Au_111_Cu_layer, y_Au_111_Cu_layer+yoffset*5.5),
    textcoords="offset points", xytext=(0,2), 
    ha='center', fontproperties=arial, color='black') 
...
plt.savefig('o-k-layersXAS.svg', format='svg', bbox_inches='tight')
