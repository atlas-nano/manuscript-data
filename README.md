...
| [`copper-electrodeposition-data/`](copper-electrodeposition-data/) | *Direct Spectroscopic Evidence of an Atom-Transfer Mechanism during Copper Electrodeposition on Gold* (Correal, Pascal *et al.*, ACS Electrochem., in press) — computational data (Zenodo [10.5281/zenodo.21448209](https://doi.org/10.5281/zenodo.21448209); XAS spectra Zenodo [10.5281/zenodo.17657023](https://doi.org/10.5281/zenodo.17657023)). |
